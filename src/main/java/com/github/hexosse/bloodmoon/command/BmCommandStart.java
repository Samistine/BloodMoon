 ...
 */
public class BmCommandStart extends PluginCommand<BloodMoon>
{
	/**
	 * @param plugin The plugin that this object belong to.
	 */
	public BmCommandStart(BloodMoon plugin)
	{
		super("start", plugin);
		this.addArgument(new CommandArgument<World>("world", ArgTypeWorld.get(), true, true, "World to start the bloodmoon."));
		this.setPermission(Permissions.ADMIN_START.toString());
	}
	...
	public boolean onCommand(CommandInfo commandInfo)
	{
		...
		if(plugin.isEnabled(world))
		{
			...
			message.add(new Message(ChatColor.GREEN + "Bloodmoon started in world " + world.getName()));
		}
		else
		{
