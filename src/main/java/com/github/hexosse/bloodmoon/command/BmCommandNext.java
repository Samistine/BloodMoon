 ...
 */
public class BmCommandNext extends PluginCommand<BloodMoon>
{
	/**
	 * @param plugin The plugin that this object belong to.
	 */
	public BmCommandNext(BloodMoon plugin)
	{
		super("next", plugin);
	...
	public boolean onCommand(CommandInfo commandInfo)
	{
		...
		if(plugin.isEnabled(world))
		{
			...
			message.add(new Message(ChatColor.GREEN + "Bloodmoon forced in world " + world.getName()));
		}
		else
		{
