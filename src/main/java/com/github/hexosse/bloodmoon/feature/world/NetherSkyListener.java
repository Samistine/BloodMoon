...
public class NetherSkyListener extends PluginListener<BloodMoon>
{
    ...
    private void sendWorldEnvironment(Player player, Environment environment) {
        ...
        PacketPlayOutRespawn packet = new PacketPlayOutRespawn(environment.getId(), EnumDifficulty.getById(world.getDifficulty().getValue()), WorldType.NORMAL, WorldSettings.a(player.getGameMode().getValue()));
