...
//		WorldConfig worldConfig = plugin.getConfig(worldName);
//
//		this.d = Math.max(this.d - ((plugin.isActive(worldName) && plugin.isFeatureEnabled(worldName, Feature.ARROW_RATE)) ? worldConfig.getInt(WorldConfig.FEATURE_ARROW_RATE_MULTIPLIER) : 1), 0);
//
//		float f;
//
//		if (this.d == 0){
